...
if __name__ == "__main__":
 print("""
    0xCrypt00o Soluation for Portswigger LAB : Username-Enumeration-Via-Different-Responses
 ...
 if len(argv)==4:
     ...
     print("call it with : python3 ./pwn-auth-username-enumeration-via-different-responses.py <url> <path to username wordlist> <path to password wordlist> ")
